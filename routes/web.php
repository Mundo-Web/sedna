...
Route::middleware(['can:Admin', 'auth'])->prefix('admin')->group(function () {
    ...
    Route::get('/topicservices', [AdminServiceSubthemeController::class, 'reactView'])->name('Admin/ServiceSubtheme.jsx');
    Route::get('/solutions', [AdminSolutionController::class, 'reactView'])->name('Admin/Solutions.jsx');
    Route::get('/topicsolutions', [AdminSolutionSubthemeController::class, 'reactView'])->name('Admin/SolutionSubtheme.jsx');
